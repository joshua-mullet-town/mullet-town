  ...
  data() {
    return {
      mainProject: {
        ...
        url: 'https://github.com/joshua-mullet-town/whisper-village/releases/download/v1.1.0/Whisper%20Village%20v1.1.0.dmg',
        buttonWidth: '16rem',
        ...
        downloadUrl: 'https://github.com/joshua-mullet-town/whisper-village/releases/download/v1.1.0/Whisper%20Village%20v1.1.0.dmg',
        isDownload: true
      },
      projects: [
        {
